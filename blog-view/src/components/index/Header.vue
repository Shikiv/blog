<template>
	<header ref="header">
		<div class="view">
			<img ref="imgbg1" src="https://www.baidu.com/img/PCfb_5bf082d29588c07f842ccde3f97243ea.png" style="display: none;">
		...
		<div class="text-malfunction" data-word="WWH's Blog">
			<div class="line"></div>
		</div>
		<div class="wrapper">
